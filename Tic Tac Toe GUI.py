...
def check_win():
    ...
    if (b[0] == b[1] == b[2]) or (b[3] == b[4] == b[5]) or (b[6] == b[7] == b[8]) or (b[0] == b[3] == b[6]) or (b[1] == b[4] == b[7]) or (b[2] == b[5] == b[8]) or (b[0] == b[4] == b[8]) or (b[2] == b[4] == b[6]):
        ...
        yes = Button(root, text='Yes', font=('Courier', 18))
        no = Button(root, text='No', font=('Courier', 18))
...
eml = Label(root, width=10, bg='black')
eml.grid(row=1, column=0)
emr = Label(root, width=10, bg='black')
emr.grid(row=1, column=4)
emt = Label(root, height=3, bg='black')
emt.grid(row=0)
l = Label(root, height=3, bg='black')
l.grid(row=4)
l2 = ''
